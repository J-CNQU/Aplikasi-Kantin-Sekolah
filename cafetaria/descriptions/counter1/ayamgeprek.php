...
<head>
  ...
  <title>Ayam Geprek - Description</title>
  ...
  <section class="description-page">
    ...
    <div class="desc-content">
      <div class="desc-image">
        <img src="../../counter 1/1. ayam geprek.png" alt="Ayam Geprek">
      </div>

      <div class="desc-info">
        <h3 class="food-name">Ayam Geprek</h3>
        <p class="food-detail">
          Ayam Geprek Spesial adalah sajian ayam goreng crispy yang digeprek bersama sambal pedas khas Indonesia.
          Dibungkus tepung renyah dan digoreng hingga keemasan, ayam ini menghadirkan perpaduan rasa gurih, pedas,
          dan nikmat yang menggugah selera.
        </p>

        <div class="qty-rating">
          <div class="menu-qty" data-menu="ayam-geprek">
      ...
      <div class="comments-wrapper">
        <div class="comments-container" id="commentsList">
          <div class="comment-card">
            <img src="../../logo deskripsi/profile.png" alt="user">
            <div class="comment-info">
              <h4>Michelle</h4>
              <p>MANTAPP!! pesesannya sesuai, makanannya pun enak</p>
            </div>
          </div>
          ...
          <div class="comment-card">
            ...
            <div class="comment-info">
              <h4>Mira</h4>
              <p>enak banget, ternyata gak salah banyak yang rekomen</p>
            </div>
          </div>
          ...
          <div class="comment-card">
            ...
            <div class="comment-info">
              <h4>Rudi</h4>
              <p>Ayamnya krispi banget dan sambalnya mantul</p>
            </div>
          </div>
          ...
          <div class="comment-card">
            ...
            <div class="comment-info">
              <h4>Sari</h4>
              <p>Porsinya pas cocok buat orang laparan😍</p>
            </div>
          </div>
          ...
          <div class="comment-card">
            ...
            <div class="comment-info">
              <h4>Budi</h4>
              <p>Ayamnya lembut banget di dalam, renyah di luar plss mau pesan lagi</p>
            </div>
          </div>
        </div>

        <button class="comment-next" id="nextBtn">
