...
<body>
  ...
  <section class="description-page">
    ...
    <div class="desc-content">
      ...
      <div class="desc-info">
        <h3 class="food-name">Nasi Uduk</h3>
        <p class="food-detail">
          Nasi uduk dimasak dengan santan, daun pandan, dan serai, menghasilkan nasi yang gurih dan harum. Disajikan
          dengan ayam goreng, telur dadar, sambal kacang, dan bawang goreng.
        </p>

        <div class="qty-rating">
          <div class="menu-qty" data-menu="nasi-uduk">
