...
<body>
  ...
  <section class="description-page">
    ...
    <div class="desc-content">
      ...
      <div class="desc-info">
        <h3 class="food-name">Nasi Hainam</h3>
        <p class="food-detail">
            Nasi hainam adalah nasi yang dimasak dengan kaldu ayam dan rempah ringan, disajikan dengan ayam rebus atau panggang serta saus jahe dan sambal khas. Rasanya lembut dan aromatik.
        </p>
        
        <div class="qty-rating">
          <div class="menu-qty" data-menu="nasi-hainam">
        ...
        <div class="comments-container" id="commentsList">
          <div class="comment-card">
            ...
            <div class="comment-info">
              <h4>Sakirah</h4>
              <p>woenakkk polllll, beli ini ges wajib</p>
            </div>
          </div>
          ...
          <div class="comment-card">
            ...
            <div class="comment-info">
              <h4>Andi</h4>
              <p>Ini rekomen banget sih perlu dibeli lagi tar</p>
            </div>
          </div>
          ...
          <div class="comment-card">
            ...
            <div class="comment-info">
              <h4>Anton</h4>
              <p>Suka banget, menu favorit pas uang nipis</p>
            </div>
          </div>
          ...
          <div class="comment-card">
            ...
            <div class="comment-info">
              <h4>Tania</h4>
              <p>Porsinya besar bisa dimakan sampai 2 kali</p>
            </div>
          </div>
          ...
          <div class="comment-card">
            ...
            <div class="comment-info">
              <h4>Sally</h4>
              <p>Rempah uduknya enak banget plssss, ini rekomen banget ges ayo dibeli</p>
            </div>
          </div>
        </div>
