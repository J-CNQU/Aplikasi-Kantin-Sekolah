    ...
    <section class="counters">
        <div class="counter-content">
            <div class="counter-background">
                <img src="../cafetaria/counter 1/iklan counter 4.png" alt="counter 1">
            </div>

            <img src="../cafetaria/logo per counter/4.png" alt="counter 1" class="counter-logo">
            ...
            <div class="list-menu">
                ...
                <div class="menu-info">
                    ...
                    <div class="menu-button">
                        ...
                        <div class="menu-qty">
                            <button class="qty-btn plus"><img src="../cafetaria/icons/plus.png" alt="+"></button>
                            <span class="qty-number">0</span>
                            <button class="qty-btn minus"><img src="../cafetaria/icons/minus.png" alt="-"></button>
                        </div>
                    </div>
                </div>
            </div>
