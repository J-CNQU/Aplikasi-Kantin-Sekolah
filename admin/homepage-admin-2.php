...
if (isset($_GET['delete_id'])) {
    ...
    if ($stmt->execute()) {
        ...
        header("Location: homepage-admin-2.php?counter=$selected_counter_num&msg=deleted");
        exit();
    } else {
...
<body class="site-bg">
    <nav class="navbar">
        ...
        <ul class="nav-links">
            <li><a class="active" href="homepage-admin-2.php">Kelola Menu Counter</a></li>
    ...
    <div class="container">
        ...
        <form method="POST" action="homepage-admin-2.php?counter=<?php echo $selected_counter_num; ?>">
            <?php if ($edit_item): ?>
            ...
            <?php if ($edit_item): ?>
                <a href="homepage-admin-2.php?counter=<?php echo $selected_counter_num; ?>" class="btns-logout">Batal
                    Edit</a>
            <?php endif; ?>
        </form>
                ...
                <?php if (!empty($menu_items)): ?>
                    <?php foreach ($menu_items as $item): ?>
                        <tr>
                            ...
                            <td>
                                <a
                                    href="homepage-admin-2.php?edit_id=<?php echo $item['id']; ?>&counter=<?php echo $selected_counter_num; ?>">Edit</a>
                                |
                                <a href="homepage-admin-2.php?delete_id=<?php echo $item['id']; ?>"
