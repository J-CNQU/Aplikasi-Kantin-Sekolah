        ...
        <div class="menu-grid">
            <div class="list-menu">
                <div class="menu-image">
                    <img src="/cafetaria/counter 1/1. nasi goreng.png" alt="nasi goreng">
                </div>
                    ...
                    <div class="menu-button">
                        ...
                        <div class="menu-qty">
                            <button class="qty-btn plus">
                                <img src="/cafetaria/icons/plus.png" alt="+">
                            </button>
                            <span class="qty-number">0</span>
                            <button class="qty-btn minus">
                                <img src="/cafetaria/icons/minus.png" alt="-">
                            </button>
                        </div>
                    </div>
                </div>
            ...
            <div class="list-menu">
                <div class="menu-image">
                    <img src="/cafetaria/counter 1/1. nasi hainam.png" alt="nasi hainam">
                </div>
                <div class="menu-info">
                    <h3 class="menu-title">Nasi Hainam</h3>
                    <p class="menu-desc">Nasi khas CafeTaria, Nasi harum lembut dengan ayam gurih, kaya rasa oriental
                        yang menenangkan.</p>
            ...
            <div class="list-menu">
                <div class="menu-image">
                    <img src="/cafetaria/counter 1/1. nasi padang.png" alt="nasi padang a">
                </div>
            ...
            <div class="list-menu">
                <div class="menu-image">
                    <img src="/cafetaria/counter 1/1. nasi uduk.png" alt="nasi uduk">
                </div>
            ...
            <div class="list-menu">
                <div class="menu-image">
                    <img src="/cafetaria/counter 1/1. nasi kuning.png" alt="nasi kuning">
                </div>

                <div class="menu-info">
                    <h3 class="menu-title">Nasi Kuning</h3>
                    <p class="menu-desc">Nasi kuning khas dihidangkan bersama ayam goreng, tempe orek, telur, dan sambal
                        bawang</p>
            ...
            <div class="list-menu">
                <div class="menu-image">
                    <img src="/cafetaria/counter 1/1. nasi padang B.png" alt="nasi padang b">
                </div>
            ...
            <div class="list-menu">
                <div class="menu-image">
                    <img src="/cafetaria/counter 1/1. nasi liwet.png" alt="nasi liwet">
                </div>
            ...
            <div class="list-menu">
                <div class="menu-image">
                    <img src="/cafetaria/counter 1/1. nasi bakar.png" alt="nasi bakar">
                </div>
            ...
            <div class="list-menu">
                <div class="menu-image">
                    <img src="/cafetaria/counter 1/1. ayam geprek.png" alt="nasi ayam geprek">
                </div>

                <div class="menu-info">
                    <h3 class="menu-title">Nasi Ayam Geprek</h3>
                    <p class="menu-desc">Nasi panas yang dihidangkan bersama ayam goreng yang digeprek dengan sambal
                        pedas</p>
